...
$(document).ready(function () {
    ...
    $(".add-form-element-btn").click(function () {
        $(".form-builder").removeClass("hidden-section");
        $(".buttons-section").addClass("hidden-section");
    });

    $(".form-builder-close-btn").click(function () {
        $(".buttons-section").removeClass("hidden-section");
        $(".form-builder").addClass("hidden-section");
    });
    $(".preview-btn").click(function () {
        $(".preview-section").removeClass("hidden-section");
        $(".main-form").addClass("hidden-section");



    });
    $(".close-preview").click(function () {
        $(".preview-section").addClass("hidden-section");
        $(".main-form").removeClass("hidden-section");
    });
...
function extractFormData() {
    ...
    $('.preview-empty-state').html(""); // Clear form preview
    ...
    if (formData.length > 0) {
        ...
        formData.forEach(function (item) {
            ...
            $('.preview-empty-state').append(formElement); // Append form elements to the preview area
        });


    } else {
        $(".preview-empty-state").html('<span class="preview-empty-state">Your form is empty, please add some elements.</span>'); // Show preview empty state message if no form data
    }
}
